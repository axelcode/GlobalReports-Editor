/*
 * ==========================================================================
 * class name  : com.globalreports.editor.graphics.text.GRParagraph
 * Begin       : 
 * Last Update : 
 *
...
public class GRParagraph {
	...
	public GRParagraph(int left, int top, int align, Graphics g) {
		this.left = left;
		this.top = top;
	...
	public void addTextRow(String fontName, int fontSize, int fontStyle, Color fontColor, String value) {
		refRow.addTextRow(fontName, fontSize, fontStyle, fontColor, value, gdc);
	}
